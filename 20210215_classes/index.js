...
// extends && super
// extends && super()
// extends --> inheriting the methods from the original class which gas being called
// super --> gets access to the parents's properties and methods
...
class Kid extends Person {
  ...
  show() {
    return `this is a kid from Person, ${this.name}`;
  }
}
